	...
	<view class="preview">
				...
				<scroll-view scroll-y>
					<view class="content">
						<view class="row">
							...
							<text class="value" selectable>12121212121奥术大师大所</text>
						</view>
						<view class="row">
						...
						<view class="row">
							...
							<text class="value" selectable>你爸爸</text>
						</view>
						<view class="row">
							<text class="label">评分：</text>
							<view class="value rateBox">
								<uni-rate readonly touchalbe size="16" v-model="rateValue" @change="onChange" />
								<view class="score">5分</view>
							</view>
						</view>
						<view class="row">
							<text class="label">摘要：</text>
							<view class="value">十七大所大所十七大所大所十七大所大所十七大所大所</view>
						</view>
						<view class="row">
		...
		<uni-popup ref="scorePopup" :is-mask-click="false">
			<view class="scorePopup">
				...
				<view class="content">
					<uni-rate allowHalf v-model="userScore" @change="onChange"></uni-rate>
					<text class="text">{{ userScore }}分</text>
				</view>
				<view class="footer">
					<button :disabled="!userScore" type="default" plain @click="submitScore" size="mini">确认评分</button>
				</view>
			</view>
		</uni-popup>
	</view>
